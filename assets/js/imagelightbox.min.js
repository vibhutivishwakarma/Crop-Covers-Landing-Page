(function(factory) {
    ...
    var $activityObject = $("<div/>")
        ...
        $overlayObject = $("<div/>", { class: "imagelightbox-overlay" }),
        $navItem = $("<a/>", { href: "#", class: "imagelightbox-navitem" }),
        $navObject = $("<div/>", { class: "imagelightbox-nav" }),
    ...
    var cssTransitionSupport = function() {
        ...
        cssTransitionTranslateX = function(element, positionX, speed) {
            ...
            options[prefix + "transition"] =
                prefix + "transform " + speed + "s ease-in";
            element.css(options);
        },
    ...
    $.fn.imageLightbox = function(opts) {
        var targetSet = "",
            ...
            _pushQuitToHistory = function() {
                ...
                var newQuery = _removeQueryField(
                    document.location.search,
                    "imageLightboxIndex"
                );
            ...
            _getQueryField = function(key) {
                var keyValuePair = new RegExp("[?&]" + key + "(=([^&#]*)|&|#|$)").exec(
                    document.location.search
                );
                            ...
                            function(e) {
                                ...
                                if (Math.abs(swipeDiff) > 50) {
                                    ...
                                    if (hasCssTransitionSupport) {
                                        ...
                                        image.animate({ left: imagePosLeft + "px" },
        ...
        this.startImageLightbox = function(element) {
            if (element) element.trigger("click.ilb7");
